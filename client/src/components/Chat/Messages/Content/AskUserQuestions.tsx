          ...
          return (
            ...
            >
              ...
              <TextareaAutosize
                ...
                className="mt-2 w-full resize-none rounded-md border border-border-light bg-surface-primary p-2 text-sm text-text-primary placeholder:text-text-secondary"
